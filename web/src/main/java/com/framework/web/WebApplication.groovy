...
//        initParameters.put("casServerUrlPrefix", "http://tu:8443/cas");
...
//        Map<String, String> initParameters = new HashMap();
//        initParameters.put("casServerUrlPrefix", "http://tu:8443/cas");
//        initParameters.put("serverName", "http://tu:8080/");
//
...
//        registration.addUrlPatterns("/*");
//        initParameters.put("casServerLoginUrl", "http://tu:8443/cas/login");
//        initParameters.put("serverName", "http://tu:8080/");
//
//        // 不拦截的请求 .* 有后缀的文件
...
//
//        // 表示过滤所有
//        initParameters.put("ignoreUrlPatternType", "com.framework.web.component.SimpleUrlPatternMatcherStrategy");
//
//        registration.setInitParameters(initParameters);
//        // 设定加载的顺序
//        registration.setOrder(1);
