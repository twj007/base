...
public class QRCodeUtil {
     ...
     * @param output
     */
    public static void dealLogoAndDesc(CodeModel info, OutputStream output) {
        //获取原始二维码图片
     ...
     * @param filePath
     */
    public static void createCodeImage(CodeModel info, String filePath) {
     ...
     * @param filePath
     */
    public static void createCodeImage(String contents, String filePath) {
